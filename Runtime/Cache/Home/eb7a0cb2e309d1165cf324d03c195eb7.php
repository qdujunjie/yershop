...
<div class="main"><div class="main_nav"><a rel="nofollow" href="<?php echo U("index/index");?>">首页</a>&gt;<p class="red fwb">帮助中心</p></div><div class="main_center"><div class="center_left">
<dl><dt><a rel="nofollow">购物流程</a></dt>
<dd><a rel="nofollow" href='javascript:vod(0);'>支付宝支付</a></dd>
<dd><a rel="nofollow"  href='javascript:vod(0);'>发票说明</dd><dd><a rel="nofollow"  href='javascript:vod(0);'>优惠券说明</a></dd></dl>
<dl class="last"><dt><a rel="nofollow">配送方式</a></dt><dd><a  href='javascript:vod(0);'>配送方式</a></dd><dd><a rel="nofollow"  href='javascript:vod(0);'>配送费用</a></dd><dd><a rel="nofollow"  href='javascript:vod(0);'>签收须知</a></dd></dl></div><div class="center_right" style="display: none;"><div class="center_right_loading"></div></div><div id="memberCenter" style="display: block;"><!-- 个人中心 初始状态 start -->
<div class="center_right" id="MemberCenterCtrl" style="display: block;">

	<span class="red" style="display: block;text-align:center;margin:20px 0 20px 37px;font-weight:bold;padding:10px;font-size:17px;"><?php echo (get_good_name($id)); ?></span>
  <form  method="post"  name="myform"  class="payform">


<div class="pay">

  <?php echo (get_docoment_content($id)); ?>
