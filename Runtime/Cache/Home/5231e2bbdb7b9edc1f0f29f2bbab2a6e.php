...
<div class="main"><div class="search_main_top">
    ...
    <div class="main_nav"><a rel="nofollow" href="<?php echo U('index/index');?>">首页</a>&gt;<p> <a href="<?php echo U('Article/index?category='.$category['name']);?>"><?php echo ($category['title']); ?></a> </p>
     </div>
<div class="ctop"> <div class="p_cate">
	 <?php if(empty($childlist)): ?>暂无分类 
	 <?php else: ?>
	  <div class="ctitle">所有分类 </div>

	  <ul>
	  <?php if(is_array($childlist)): $i = 0; $__LIST__ = $childlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Article/lists/?category='.$vo['name']);?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul><?php endif; ?>
  </div>
    ...
    <div id="yc-mod-slider">
            <div id="slideshow" class="box_skitter fn-clear">
               <ul>
                    <li>
                        <img alt="Joomla模板与内容的融合设计" class="cubeRandom" src="/Public/Home/images/slider1.jpg" /></li>
                    <li>
                        <img alt="野草工作室一直在用心建站" class="cubeRandom" src="/Public/Home/images/slider2.jpg" /></li>
                    <li>
                        <img alt="利用Joomla+SEO提升网络营销竞争力" class="cubeRandom" src="/Public/Home/images/slider3.jpg" /></li>
                </ul>
            </div>
            <script type="text/javascript" src="/Public/static/js/slideshow.js"></script>
        </div>
   
    <!-- 代码 结束 -->
	
	  </div>
	  <div class="ml_content"><ul class="ml_content_top"><li><a rel="nofollow" href="" class="mct_a active">热度</a></li><li><a rel="nofollow" href="<?php echo U('Article/new?category='.$category['name']);?>" class="mct_a">最新</a></li></ul><ul class="ml_content_main">
      
         <?php $category=D('Category')->getChildrenId($category['id']);$__LIST__ = D('Document')->page(!empty($_GET["p"])?$_GET["p"]:1,10)->lists($category, '`level` DESC,`id` DESC', 1,true); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li>
             ...
             <p> <a href="<?php echo U('Article/detail?id='.$list['id']);?>"> <?php echo ($list["title"]); ?></a></p>   
			  <p><span class="red" title="预览：<?php echo (get_good_price($list["id"])); ?>">价格：<?php echo (get_good_price($list["id"])); ?></span></p>
                        <p><span class="gray" title="预览：<?php echo ($list["view"]); ?>">预览：<?php echo ($list["view"]); ?></span></p>&nbsp;&nbsp;
              </li><?php endforeach; endif; else: echo "" ;endif; ?>
