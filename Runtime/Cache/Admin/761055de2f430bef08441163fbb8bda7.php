...
<link rel="stylesheet" href="/Public/static/style/UploadImages.css"><div class="main-title cf">
		<h2>
...
<div class="tab-wrap">
    ...
    <input type="hidden" name="<?php echo ($field["name"]); ?>" value="<?php echo ($valStr); ?>" class="icon <?php echo ($field["name"]); ?>" />
  <?php $valArr= explode(',',$data[$field['name']]); ?>  <div class="upload-img-box">
