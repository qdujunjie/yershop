...
<div id=wwwzzjsnet>
  ...
  <li class="img"><img src="<?php echo (get_cover($info["cover_id"],'path')); ?>" height="50" width="50"/></li>
   <?php if(!empty($pics)): if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><img src="<?php echo (get_cover($v,'path')); ?>" data-id="<?php echo ($v); ?>"/> </li><?php endforeach; endif; else: echo "" ;endif; endif; ?> 
		<?php if(empty($pics)): ?><li><img src="/Public/Home/images/img02_20110119zzjs_net.jpg"> </li>
				<li><img src="/Public/Home/images/img03_20110119zzjs_net.jpg"> </li>
				<li><img src="/Public/Home/images/img04_20110119zzjs_net.jpg"> </li><?php endif; ?>
			</ul>
		</div>
...
<div class="details_right"><dl><dt>本周热门物品</dt><?php if(is_array($viewlist)): $i = 0; $__LIST__ = array_slice($viewlist,1,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd><a class="details_right_img" href="<?php echo U('Article/detail?id='.$vo['id']);?>" title="<?php echo ($vo["title"]); ?>"><img src="<?php echo (get_cover($vo["cover_id"],'path')); ?>"  alt="<?php echo ($vo["title"]); ?>" style="display: inline-block;"></a><a href="<?php echo U('Article/detail?id='.$vo['id']);?>" class="details_right_title" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a><span class="fwb mcm_title_price">￥<span class="red"><?php echo (get_good_price($vo["id"])); ?></span></span></dd><?php endforeach; endif; else: echo "" ;endif; ?></dl></div></div>
