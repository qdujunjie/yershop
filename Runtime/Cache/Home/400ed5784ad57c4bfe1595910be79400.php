...
<div class="main"><div class="main_nav"><a rel="nofollow" href="<?php echo U("index/index");?>">首页</a>&gt;<p class="red fwb">支付中心</p></div><div class="main_center"><div class="center_left"><dl><dt><a rel="nofollow">订单中心</a></dt>
<dd><a rel="nofollow" href='<?php echo U("center/index");?>'>主页</a></dd>
...
<div class="center_right" id="MemberCenterCtrl" style="display: block;">
  ...
  <form action='<?php echo U("Pay/index");?>' method="post"  name="myform"  class="payform">
	<div class="tab-content">

<div class="pay">
<?php if(empty($codeid)): ?><div class="form-group">
    <label for="inputPassword" class="col-sm-2 control-label"></label>
    <div class="col-sm-5">
   支付金额：<?php echo ($goodprice); ?> <input type="text" name="money" class="form-control" id="goodprice" value="<?php echo ($goodprice); ?>">元
    </div>
  </div>
<?php else: ?>
 <div class="form-group">
    <label for="inputPassword" class="col-sm-2 control-label"></label>
    <div class="col-sm-5">
    支付订单号：<?php echo ($codeid); ?><input type="hidden"  name="orderid" class="form-control" id="orderid" value="<?php echo ($codeid); ?>">(<a Style="color:blue;font-size:14px;"href="<?php echo U('order/detail?id='.$codeid);?>" target=_blank>订单详情</a>)
    </div>
  </div>
 <div class="form-group">
    <label for="inputPassword" class="col-sm-2 control-label"></label>
    <div class="col-sm-5">
   支付金额：<?php echo ($goodprice); ?> 元<input type="hidden" name="money" class="form-control" id="goodprice" value="<?php echo ($goodprice); ?>">
    </div>
  </div><?php endif; ?>
  <div class="form-group paytype"><label>支付方式：</label><br/>
   <div class="paylogo">
  <label><input type="radio" name="paytype" value="alipay" checked=""/> 支付宝<img src="/Public/Home/images/alipay.gif"></label>
                <label><input type="radio" name="paytype" value="tenpay" /> 财付通<img src="/Public/Home/images/tenpay.png"></label>
                <label><input type="radio" name="paytype" value="unionpay" /> 银联<img src="/Public/Home/images/union.png"></label><br/><br/>
				<label><input type="radio" name="paytype" value="palpay" /> 贝宝<img src="/Public/Home/images/palpay.png"></label>
                <label><input type="radio" name="paytype" value="yeepay" /> 易付宝<img src="/Public/Home/images/yeepay.png"></label>
                <label><input type="radio" name="paytype" value="kuaiqian" /> 快钱<img src="/Public/Home/images/kuaiqian.png"></label>
