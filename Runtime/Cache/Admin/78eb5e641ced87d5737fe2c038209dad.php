...
<body>
	...
	<div class="main-title">
		<h2>浏览明细 [ <?php if(isset($_GET['group'])): ?><a href="<?php echo U('index');?>">全部</a><?php else: ?><strong>全部</strong><?php endif; ?>&nbsp;<?php if(is_array($group)): foreach($group as $key=>$vo): if(($group_id) != $key): ?><a href="<?php echo U('index?group='.$key);?>"><?php echo ($vo); ?></a><?php else: ?><strong><?php echo ($vo); ?></strong><?php endif; ?>&nbsp;<?php endforeach; endif; ?> ]</h2>
	</div>
	...
	<div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="void" class="search-input" value="<?php echo I('id');?>" placeholder="请输入id">
                <a class="sch-btn" href="javascript:;" id="search" url="/admin.php?s=/Lookup/category.html"><i class="btn-search"></i></a>
            </div>
        </div>
	</div>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"></td>
						...
						<td><?php echo (get_nickname($uid)); ?></td>
...
<?php echo ($_page); ?>
 ...
 <script type="text/javascript">
        $(function() {
            ...
            //导航高亮
            highlight_subnav('<?php echo U('category');?>');
            //点击排序
