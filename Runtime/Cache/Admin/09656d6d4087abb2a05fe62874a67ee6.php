...
<div class="tab-content">						
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="id" value="<?php echo ((isset($info["id"]) && ($info["id"] !== ""))?($info["id"]):''); ?>">
			</div>
		</div>
		...
		<div class="form-item">
			<label class="item-label">管理员备注<span class="check-tips">（总额）</span></label>
			<div class="controls">
...
<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="send_name" value="<?php echo C('SHOPNAME');?>">
			</div>
</div>
<div class="form-item">
			<label class="item-label">发货人联系方式<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="send_contact" value="<?php echo C('CONTACT');?>">
			</div>
</div>
<div class="form-item">
			<label class="item-label">发货人地址<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="send_address" value="<?php echo C('ADDRESS');?>">
			</div>
</div>
