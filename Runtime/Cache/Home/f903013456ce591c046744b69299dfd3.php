...
<span  style="display: block;padding:15px;font-size:17px;text-align:center;color:red;margin:20px 0;"><?php echo ($msg); ?> &nbsp;&nbsp;<?php echo ($id); ?></span>

	<form action='<?php echo U();?>' method="post" name="actform" style="float:left;;width:30%" >
	<input type="hidden" name="id" value="<?php echo ($id); ?>">
       <div id="write">
	   
<ul> <li><div class="form-item">
			<label class="item-label">提示:<span class="red"><?php echo ($info); ?></span> </label>
	...
	<?php else: ?>
        ...
        <?php if(is_array($detaillist)): $i = 0; $__LIST__ = $detaillist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$po): $mod = ($i % 2 );++$i;?><tbody width="600px;">
		   <tr width="100%">
                ...
                <th width="28%">时间：<?php echo (date('Y-m-d',$po["time"])); ?></th> 
